...
struct StoryBrain {
    ...
    mutating func nextStory(userInput: String) {
        ...
        if userInput == storiesArray[storyNumber].choice1 {
            storyNumber = storiesArray[storyNumber].choice1Destination
            } else {
                storyNumber = storiesArray[storyNumber].choice2Destination
            }
